  ...
  try {
    ...
    await database.runAsync(
      ...
      [
        ...
        product.barcode || '',
        barcodesJson,
        (product.buyPrice !== undefined && product.buyPrice !== null && product.buyPrice !== '' && !isNaN(parseFloat(product.buyPrice))) ? parseFloat(product.buyPrice) : null,
        product.category || '',
        product.photoUri || '',
  ...
  try {
    ...
    await database.runAsync(
      ...
      [
        ...
        sale.quantity,
        sale.unitPrice,
        (sale.buyPrice !== undefined && sale.buyPrice !== null && sale.buyPrice !== '' && !isNaN(parseFloat(sale.buyPrice))) ? parseFloat(sale.buyPrice) : null,
        sale.totalAmount,
        sale.date || '',
